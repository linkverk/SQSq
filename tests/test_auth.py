"""Tests for auth.py — login, lockout, case-insensitive usernames, password change."""
...
def test_super_admin_login_case_insensitive():
    # C1: username is case-insensitive; the password is not changed/affected.
